...
from Code.General_Utils import parse_csv_json_data, write_data
from Code.Progress_Utils import update_progress


def main_algorithm(filename, output_filename):
    update_progress(0)
    #==============================================================================
    # Data Input
    #==============================================================================
    ...
    y_prob_df=pd.DataFrame(np.column_stack((y_test, y_prob)))
    write=write_data(y_prob_df, output_filename)
